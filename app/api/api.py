...
from app.api.v1.endpoints import convert_task, model, project, system, train_task, user
...
api_router.include_router(train_task.router, prefix="/tasks", tags=["training"])
