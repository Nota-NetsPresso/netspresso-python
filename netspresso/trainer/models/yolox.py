...
class DetectionYoloXXModelConfig(ModelConfig):
    task: str = "detection"
    name: str = "yolox_x"
    architecture: ArchitectureConfig = field(default_factory=lambda: CSPDarkNetXArchitectureConfig(
        neck={
            "name": "yolopafpn",
            "params": {
                "dep_mul": 1.33,
    ...
    losses: List[Dict[str, Any]] = field(default_factory=lambda: [
        {"criterion": "yolox_loss", "weight": None, "l1_activate_epoch": 1}
    ])
...
class DetectionYoloXLModelConfig(ModelConfig):
    task: str = "detection"
    name: str = "yolox_l"
    architecture: ArchitectureConfig = field(default_factory=lambda: CSPDarkNetLArchitectureConfig(
        neck={
            "name": "yolopafpn",
            "params": {
                "dep_mul": 1.0,
...
class DetectionYoloXMModelConfig(ModelConfig):
    task: str = "detection"
    name: str = "yolox_m"
    architecture: ArchitectureConfig = field(default_factory=lambda: CSPDarkNetMArchitectureConfig(
        neck={
            "name": "yolopafpn",
            "params": {
                "dep_mul": 0.67,
...
class DetectionYoloXSModelConfig(ModelConfig):
    ...
    architecture: ArchitectureConfig = field(default_factory=lambda: CSPDarkNetSArchitectureConfig(
        neck={
            "name": "yolopafpn",
            "params": {
                "dep_mul": 0.33,
