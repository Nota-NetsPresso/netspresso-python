...
class ClassificationResNet18ModelConfig(ModelConfig):
    ...
    name: str = "resnet18"
    architecture: ArchitectureConfig = field(default_factory=lambda: ResNet18ArchitectureConfig(
        head={
            "name": "fc",
            "params": {
                "num_layers": 1,
...
class ClassificationResNet34ModelConfig(ModelConfig):
    task: str = "classification"
    name: str = "resnet34"
    architecture: ArchitectureConfig = field(default_factory=lambda: ResNet34ArchitectureConfig(
        head={
            "name": "fc",
            "params": {
                "num_layers": 1,
...
class ClassificationResNet50ModelConfig(ModelConfig):
    task: str = "classification"
    name: str = "resnet50"
    architecture: ArchitectureConfig = field(default_factory=lambda: ResNet50ArchitectureConfig(
        head={
            "name": "fc",
            "params": {
                "num_layers": 1,
...
class SegmentationResNet50ModelConfig(ModelConfig):
    ...
    losses: List[Dict[str, Any]] = field(default_factory=lambda: [
        {"criterion": "seg_cross_entropy", "ignore_index": 255, "weight": None}
    ])
